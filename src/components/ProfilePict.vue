<template>
  <section 
    ...
    <div data-aos="slide-up" class="mt-10 w-full text-center text-slate-800 text-sm">
      <p class="text-amber-800 text-[2rem] font-semibold tangerine-font"> {{ source.name }}</p>
      <p class="text-amber-800 mb-3 mt-1 font-semibold">Anak dari pasangan Bapak {{ source.parents[0] }} dengan Ibu {{ source.parents[1] }}</p>
